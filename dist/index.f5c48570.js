...
var _projectsDataJs = require("./projects-data.js");
...
const showProject = function(hashStr) {
    ...
    const proj = (0, _projectsDataJsDefault.default)[str];
    if (!proj) return;
    overlay.classList.remove("u-hidden");
    _projectJs.handleDisplayProject(projectModal, proj);
};
showProject(window.location.hash);
window.addEventListener("hashchange", (evt)=>showProject(evt.newURL));

},{"./project.js":"8ulW8","./projects-data.js":"4Hj4c","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8ulW8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handleProjectHover", ()=>handleProjectHover);
parcelHelpers.export(exports, "handleDisplayProject", ()=>handleDisplayProject);
parcelHelpers.export(exports, "addEventHandler", ()=>addEventHandler);
const handleProjectHover = function() {
    const video = this.querySelector("video");
    const videoPlaying = !!(video.currentTime > 0 && !video.paused && !video.ended && video.readyState > 2);
    if (videoPlaying) return;
    video.play().then(()=>console.log("Video loaded and playing")).catch(console.log);
};
const handleDisplayProject = function(displayContainer, proj) {
    ...
    const linkIcon = displayContainer.querySelector(".project__actions").querySelector("#project-url");
    linkIcon.style.visibility = !proj.url ? "hidden" : "visible";
    proj.url && (linkIcon.href = proj.url);
    const githubLinkIcon = displayContainer.querySelector(".project__actions").querySelector("#github-url");
...
const addEventHandler = function(ev, handler) {
...
exports.default = {
    ...
    dgmmc: {
        name: "DGMMC",
        details: "I built this website for an organization that conducts competitions among high school students annually. This site eased student registration and announcement of yearly competition results.",
        techUsed: [
            "HTML",
            "CSS",
            "Sass",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4qavH","8ZNvh"], "8ZNvh", "parcelRequireb020")
